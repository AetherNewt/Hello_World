...
class Car(models.Model):
    ...
    # Field name made lowercase.
    carpricenew = models.DecimalField(
        db_column='CarPriceNew', max_digits=15, decimal_places=2)
    # Field name made lowercase.
    ...
    # Field name made lowercase.
    cartankcapacity = models.CharField(
        db_column='CarTankCapacity', max_length=255)
    # Field name made lowercase.
    ...
    # Field name made lowercase.
    carstandardtransmission = models.CharField(
        db_column='CarStandardTransmission', max_length=255)
    # Field name made lowercase.
    ...
    # Field name made lowercase.
    avaliable = models.IntegerField(db_column='Avaliable')
    # Field name made lowercase.
    roadworthy = models.IntegerField(db_column='RoadWorthy')

    @classmethod
    def update_avaliable(self, id, value):
        car = self.objects.filter(carid=id)
        if(car.count() == 0):
            return 'failed'
        else:
            self.objects.filter(carid=id).update(avaliable=value)
            return 'success'

    @classmethod
    def update_roadworthy(self, id, value):
        car = self.objects.filter(carid=id)
        if(car.count() == 0):
            return 'failed'
        else:
            self.objects.filter(carid=id).update(roadworthy=value)
            return 'success'
...
class Customer(models.Model):
    ...
    customerphonenumber = models.CharField(
        db_column='CustomerPhoneNumber', max_length=255)
    # Field name made lowercase.
    customeraddress = models.CharField(
        db_column='CustomerAddress', max_length=255)
    # Field name made lowercase.
    customeroccupation = models.CharField(
        db_column='CustomerOccupation', max_length=255)
    # Field name made lowercase.
    customerdob = models.CharField(db_column='CustomerDOB', max_length=255)
    # Field name made lowercase.
    customergender = models.CharField(
        db_column='CustomerGender', max_length=45)
...
class Orderrecord(models.Model):
    ...
    # Field name made lowercase.
    ordercreatedate = models.CharField(
        db_column='OrderCreateDate', max_length=255)
    # Field name made lowercase.
    orderstatus = models.CharField(db_column='OrderStatus', max_length=255)
    # Field name made lowercase.
    orderpickupdate = models.DateField(db_column='OrderPickupDate')
    # Field name made lowercase.
    orderreturndate = models.DateField(db_column='OrderReturnDate')
    # Field name made lowercase.
    ...
    # Field name made lowercase.
    orderpickupstoreid = models.ForeignKey(
        'Store', models.DO_NOTHING, related_name="StorePickup", db_column='OrderPickupStoreID')
    # Field name made lowercase.
    orderreturnstoreid = models.ForeignKey(
        'Store', models.DO_NOTHING, related_name="OrderPickup", db_column='OrderReturnStoreID')

    @classmethod
    def get_orders_by_pickup_storeID(self, storeID):
        orders = self.objects.filter(
            orderpickupstoreid=storeID)
        return orders
...
class Staff(models.Model):
    ...
    # Field name made lowercase.
    staffemailaddress = models.CharField(
        db_column='StaffEmailAddress', max_length=255)
...
class Store(models.Model):
    # Field name made lowercase.
    storeid = models.AutoField(db_column='StoreID', primary_key=True)
    # Field name made lowercase.
    branchname = models.CharField(
        db_column='BranchName', unique=True, max_length=255)
    # Field name made lowercase.
    branchstreetaddress = models.CharField(
        db_column='BranchStreetAddress', max_length=255)
    # Field name made lowercase.
    ...
    # Field name made lowercase.
    branchphonenumber = models.CharField(
        db_column='BranchPhoneNumber', max_length=255)

    @classmethod
    def get_store(self, storename):
        store = self.objects.filter(branchname__icontains=storename)
        return store

    @classmethod
    def get_storeID(self, storename):
        storeID = self.objects.filter(branchname__icontains=storename)
...
class User(models.Model):
    ...
    useremail = models.CharField(
        db_column='UserEmail', unique=True, max_length=255)
    # Field name made lowercase.
